...
from dash import html, dcc,callback_context,MATCH,ALL
    ...
    [
        ...
        dbc.Row([
            ...
            dbc.Col([
                ...
                dcc.Dropdown(id='drop_down_tables', multi=True, persistence=True,options ={'value':'bla'},value='bla'),
