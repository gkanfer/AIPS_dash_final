import dash
dash.register_page(__name__,name='Target', path='/target_segmentation')
...
def Parameters_initiation(nn,ch,ch2, image,cont,channel,int_on_nuc,high,low,bs,os,ron,bsc,int_on_cyto,osc,gt,roc,rocs):
