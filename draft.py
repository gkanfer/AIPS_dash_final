'''
git add .
git commit -m "01-24-2021 c color image output corrected"
git push origin -u AIPS_Dash
'''
            ...
            dbc.Col([
                dcc.Tabs(id = 'tabs', value = '',
                        children=[
                            ...
                            dcc.Tab(label="Select module for activation", id = "Module-tab-id", value="Module-tab",style={'color': 'black'},selected_style={'color': 'red'},disabled=True)
                    ]),
